-- MapMissions Database Setup
-- Run this entire script in your Supabase dashboard to create the MapMissions tables
...
SELECT 'MapMissions tables created successfully!' as status;